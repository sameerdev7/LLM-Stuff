...
from CausalSelAttention import CausalSelfAttention
from MLP import MLP
...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
      ...
      # generate token and postion embeddings
      ...
      if targets is not None:
        # computer the loss if we are given targets
